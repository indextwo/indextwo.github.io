...
//	
//	Description:
//	Calculates the percentage of the viewport a given element/set of elements takes up (vertical only, at the moment)
//
//	Example usages:
...
//	
//	Project Home Page:
//	http://indextwo.github.io/jquery.vnm.percentwithinviewport/
//	
//	GitHub repository:
//	https://github.com/indextwo/jquery.vnm.percentwithinviewport/
//	
...
(function ($) {
	$.fn.percentWithinViewport = function(options) {
		...
		this.each(function() {
			...
			$(this).attr('data-viewport-percent', percent);
